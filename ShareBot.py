...
from Data.zip.UserAgent import UserAgent
...
if __name__ == "__main__":
    Clear()
    itemID = Write.Input("Video Linki > ", Colors.red_to_purple, interval=0.0001)
    amount = Write.Input("Sayı (0=inf) > ", Colors.red_to_purple, interval=0.0001)
    NThread = Write.Input(" Gönderilme Zaman Aralığı > ", Colors.red_to_purple, interval=0.0001)
